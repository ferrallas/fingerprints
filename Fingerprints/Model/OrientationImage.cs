...
namespace Fingerprints.Model
{
    ...
    public class OrientationImage
    {
        ...
        public double AngleInRadians(int row, int col) => IsNullBlock(row, col) ? double.NaN : _orientations[row, col] * Math.PI / 180;


        public bool IsNullBlock(int row, int col) => _orientations[row, col] == Null;
