...
namespace Fingerprints.Medina2012
{
    public static class Medina2012Matcher
    {
        ...
        public static IEnumerable<Match> Match(IStoreProvider<MtripletsFeature> storage, Bitmap bitmap)
        {
            var extract = Extract(ImageProvider.AdaptImage(bitmap));
        ...
        private static List<MinutiaPair> GetGlobalMatchingMtiae(IList<MinutiaPair> localMatchingPairs, MinutiaPair refMtiaPair,ref int notMatchingCount)
        {
